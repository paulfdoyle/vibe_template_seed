...
- **Dependencies/data:** `support/bugmgmt/issues/issues.jsonl`, `support/scripts/issues.py`, `support/ui/bugmgmt_issues.html`.
...
- Docs Expert: Keep `support/docs/process.md`, `support/docs/projectplan.md`, `README.md`, and `AGENTS.md` aligned with the BugMgmt workflow.
...
- Updated `support/docs/projectplan.md`, `support/docs/process.md`, `README.md`, and `AGENTS.md`.
