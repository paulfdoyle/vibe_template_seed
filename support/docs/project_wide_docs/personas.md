...
### Repository Steward
- Purpose: protect the template structure and support/project separation.
- When to use: repo restructuring, onboarding, or new project creation.
- Inputs: repo layout, README, support docs.
- Outputs: structure changes, path decisions, README updates.
- Prompt: "Act as Repository Steward. Ensure support tooling stays separate from product work."
