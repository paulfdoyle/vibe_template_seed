...
Use these prompts when reviewing project phases or change proposals. Activate only personas that match the scope and risk. Each persona should produce concrete outputs in this repo.

## Reviewer/Sponsor
- Purpose: confirm progress, quality, and go/no-go readiness.
- When to use: phase gates, close-out reviews.
- Inputs: `support/ui/PM.html`, `support/docs/projectplan.md`, BugMgmt exports.
...
- Inputs: `support/docs/projectplan.md`, project phase docs.
...
## QA Lead
- Purpose: identify risks, edge cases, and validation signals.
- When to use: UI or script changes, release readiness.
- Inputs: BugMgmt UI, PM.html, scripts.
- Outputs: test scenarios and pass/fail criteria.
- Prompt: "Act as QA Lead. List edge cases and acceptance signals."

## QA Engineer
- Purpose: regression and sanity checks.
- When to use: post-change verification.
- Inputs: updated UI pages, exports, docs.
- Outputs: test checklist with expected results.
- Prompt: "Act as QA Engineer. Provide a short regression checklist."

## Docs Expert
- Purpose: keep docs accurate, consistent, and linked.
- When to use: any process or structure change.
- Inputs: `support/docs` and `projects` docs.
...
## UI/Accessibility
- Purpose: usability and accessibility checks.
...
- Inputs: `support/bugmgmt/issues/issues.jsonl`.
...
- Inputs: `support/scripts/*.py`, UI exports.
