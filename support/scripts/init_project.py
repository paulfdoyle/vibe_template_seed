...
def _render_project_row(
    ...
    return textwrap.dedent(
        ...
        {indent}      <a href="bugmgmt_issues.html">BugMgmt UI</a>
        {indent}    </div>
        {indent}  </td>
        {indent}</tr>"""
    )
          ...
          <div class="container">
            <header class="hero">
              <div>
                ...
                <p class="muted small">Owner: {escaped_owner} · Last updated: {date_str}</p>
              </div>
              <div class="badges">
                <a class="btn" href="PM.html">Project Management</a>
                <a class="btn" href="bugmgmt_issues.html">BugMgmt</a>
                <a class="btn" href="docs/projectplan.html">Project Plan</a>
              </div>
            </header>
            ...
            <section class="card">
              ...
              <p class="muted small">Open the formatted summary document for full details.</p>
              <div class="links">
                <a href="docs/projects/{project}/project_summary_{project}.html">Project Summary</a>
              </div>
            </section>
            ...
            <section class="card">
              <h2 class="h4">Key Links</h2>
              <div class="links">
                <a href="docs/projects/{project}/project_summary_{project}.html">Project Summary</a>
                <a href="docs/projectplan.html">Project Plan</a>
                <a href="docs/process.html">Process</a>
                <a href="docs/project_wide_docs/personas.html">Personas</a>
                <a href="bugmgmt_issues.html">BugMgmt</a>
              </div>
            </section>

            <p class="footer muted">Local, static detail page. Keep dates and phase status current.</p>
          </div>
        </body>
        </html>
        """
...
def _update_projectplan(
    ...
    if f"projects/{project}/" in content:
        raise SystemExit(f"{projectplan_path} already references projects/{project}/")
    block = textwrap.dedent(
        f"""\
        - **{project} (planning)**
          - Summary: `projects/{project}/project_summary_{project}.md`
          - Phases root: `projects/{project}/phases/`
          - Issues log: use BugMgmt entries with `project: "{project}"`
          - Phases overview:
            - Phase 01 — {phase_name} (planning): see `projects/{project}/phases/phase01/`.
          - Phase directory map:
            - `projects/{project}/phases/phase01/phase_definition.md` — definition of Phase 01.
            - `projects/{project}/phases/phase01/action_plan_phase01.md` — action plan for Phase 01 (links to stage actions under `projects/{project}/phases/phase01/actions/`).
        """
    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--no-projectplan", action="store_true", help="Skip updating support/docs/projectplan.md")
    parser.add_argument("--no-ui", action="store_true", help="Skip updating support/ui/PM.html and project detail page")
...
def main() -> None:
    ...
    phase_def_body = textwrap.dedent(
        ...
        - **Stages:**
          - {stage_name} stage -> `projects/{project}/phases/phase01/actions/{project}_phase01_stage_{stage_slug}_action.md`
        - **Dependencies:** None.
        - **Risks/assumptions:** Keep scope focused; remain PII-free.
        - **Links:** `support/docs/projectplan.md`, `projects/{project}/project_summary_{project}.md`
        """
    )
    action_plan_body = textwrap.dedent(
        ...
        - **Phase:** see `projects/{project}/phases/phase01/phase_definition.md`.
        - **Stage list:**
          - {stage_name} stage -> `projects/{project}/phases/phase01/actions/{project}_phase01_stage_{stage_slug}_action.md`
    ...
    stage_action_body = textwrap.dedent(
        ...
        - **Dependencies/data:** `support/docs/process.md`, `support/docs/projectplan.md`, `projects/{project}/project_summary_{project}.md`
        ...
        ## Personas (record outputs; use `support/docs/templates/review_checklists.md`)
        - Reviewer/Sponsor:
    ...
    if not args.no_projectplan:
        updated_projectplan = _update_projectplan(
            repo_root / "support" / "docs" / "projectplan.md",
            project,
            phase_name,
            args.dry_run,
        )

    issues_path = repo_root / "support" / "scripts" / "issues.py"
    ...
    updated_pm = False
    if not args.no_ui:
        detail_path = repo_root / "support" / "ui" / f"project_{project}.html"
        ...
        updated_pm = _update_pm_html(
            ...
            stage_slug,
            today,
            repo_root / "support" / "bugmgmt" / "issues" / "issues.jsonl",
            args.dry_run,
        )
    ...
    if updated_projectplan:
        print("Updated support/docs/projectplan.md")
    if updated_prefix:
        print("Updated support/scripts/issues.py PROJECT_PREFIXES")
    if updated_owner:
        print("Updated support/scripts/issues.py PROJECT_OWNERS")

    print("Next steps:")
    if not args.no_ui:
        print("  - Review support/ui/PM.html and the new support/ui/project_<project>.html detail page.")
    print("  - Run python3 support/scripts/render_docs.py to refresh support/ui/docs/.")
    print("  - Regenerate BugMgmt exports if you changed issues or prefixes.")
