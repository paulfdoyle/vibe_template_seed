...
def _build_doc(md_path: Path, out_path: Path, repo_root: Path) -> None:
    ...
    css_path = repo_root / "support" / "ui" / "style" / "bugmgmt.css"
    pm_path = repo_root / "support" / "ui" / "PM.html"
...
<body>
  <div class=\"container\">
    <header class=\"hero\">
      ...
      <div class=\"badges\">
        <a class=\"btn\" href=\"{pm_rel}\">Project Management</a>
...
def main() -> None:
    ...
    parser.add_argument("--support", type=Path, default=Path("support/docs"), help="Support docs root")
    parser.add_argument("--projects", type=Path, default=Path("projects"), help="Projects root")
    parser.add_argument("--out", type=Path, default=Path("support/ui/docs"), help="Output HTML root")
