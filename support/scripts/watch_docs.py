#!/usr/bin/env python3
"""Watch markdown under support/docs and projects, auto-rendering on change."""
...
def _render_once(repo_root: Path) -> int:
    script_path = repo_root / "support" / "scripts" / "render_docs.py"
...
def main() -> None:
    ...
    support_root = repo_root / "support" / "docs"
    ...
    try:
        while True:
            ...
            if latest > last_seen:
                print("Docs changed. Rendering support/ui/docs...")
