...
<body>
  <div class="container">
    ...
    <div class="card filters">
      ...
      <div class="filter-hint">Source: support/bugmgmt/issues/issues.jsonl · Regenerate via <code>python3 support/scripts/issues.py list --format html --output support/ui/bugmgmt_issues.html</code></div>
    </div>
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data",
        type=Path,
        default=Path("support/bugmgmt/issues/issues.jsonl"),
...
def main() -> None:
    ...
    if args.format == "json":
        ...
        default_out = Path("support/bugmgmt/exports/json/bugmgmt_issues.json")
    else:
        # derive relative JSON path for the UI to fetch (defaults assume support/ui alongside support/bugmgmt/exports)
        default_out = Path("support/ui/bugmgmt_issues.html")
        json_path = Path("support/bugmgmt/exports/json/bugmgmt_issues.json")
