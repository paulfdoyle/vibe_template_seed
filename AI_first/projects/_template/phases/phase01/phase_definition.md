...
- **Objective:** Establish the baseline plan and workflow for <project>.
...
- **Stages:**
  - <stage_name> stage -> `AI_first/projects/<project>/phases/phase01/actions/<project>_phase01_stage_<stage_name>_action.md`
- **Dependencies:** None.
