...
- [ ] Adoption guide added (DOCS/template_howto.md) with steps to start a new project and use templates.
- [ ] Paths/commands verified (data/export/UI dirs configurable in scripts/issues.py via flags/env).
- [ ] Sample data is PII-free; deterministic ordering noted.
- [ ] Links resolve: DOCS/process.md, projectplan.md, personas.md, templates/, sample project, BugMgmt commands, UI template.
